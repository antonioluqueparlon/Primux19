...
<body>
    ...
    $noticia1 = NoticiaController::recuperarNoticiaApartadoMotorMasReciente();
            ...
            <section class="content">
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-12 d-sm-none d-none d-md-block">
                        ...
                        <?php
                        //PARA PÁGINA PRINCIPAL RECUPERAMOS 4 NOTICIAS DE MANERA ALEATORIA
                        $noticia1 = NoticiaController::recuperarNoticiaApartadoMotorDerecha();
                        foreach ($noticia1 as $value) {
                        ?>
                            <div class="row">
                                <div class="col-md-12">
    ...
    -->
          ...
          <li data-target="#demo" data-slide-to="2"></li>
                            ...
                            <div class="carousel-inner">
                                <?php
                                //PARA PÁGINA PRINCIPAL RECUPERAMOS 4 NOTICIAS DE MANERA ALEATORIA
                                $noticia1 = NoticiaController::recuperarNoticiaApartadoMotorDerechaUnasolo();
                                foreach ($noticia1 as $value) {
                                ?>
                    ...
                    <?php
                    $noticiasUltimas = NoticiaController::recuperarNoticiasUltimasNoticiasMotor();
