...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia">El futuro de los Samsung Galaxy Note tras los nuevos Galaxy S21 queda más en entredicho: ahora comparten lo que les hacía únicos</h1>
                </div>
                <div class="col-12">
                    <img src="https://i.blogs.es/9a5143/adios/1366_2000.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        ...
                        <!-- BREAK 3 -->
                        <h2>Samsung los crió y ellos se juntaron</h2>

                        <p>Yendo a los orígenes de los Galaxy Note, allá por 2011, el Samsung Galaxy Note se trataba de un móvil distinto al ser más grande (146,85 milímetros de altura frente a los 125,3 de un Galaxy SII) y llevar un stylus (el S Pen). Sobre todo viéndolo frente a uno de los otros 110 móviles que Samsung presentaba ese año, y más concretamente comparándolo con el Galaxy S de ese año: el Samsung Galaxy S II.

                            Como decíamos, los estrenos importantes se dividían más allá de los distintos tipos de uso que uno u otro modelo facilitaba, Pasó, por ejemplo, con la doble cámara, que de manera relativamente tardía con respecto a sus rivales dada la moda fue el Samsung Galaxy Note 8</p>
                        <!-- BREAK 4 -->

                        <p>Pero las similitudes entre una y otra serie iban aumentando: modelo a modelo veíamos en las dos gamas pantalla curva, procesador a la última, la máxima RAM que colocaba el fabricante, cámaras muy similares y, sobre todo, tamaño de pantallas. Quizás esto último es, en gran parte, lo que empezó a canibalizar la especialidad de los Note, cuando la pantalla dividida ya era igual de cómoda tanto en un panel como en otro, más allá del recurso del S Pen.</p>
                        </div>
