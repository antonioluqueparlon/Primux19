...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia">Qualcomm presenta su nuevo lector de huellas ultrasónico bajo la pantalla: dice ser un 50% más rápido que el anterior</h1>
                </div>
                <div class="col-12">
                    <img src="https://i.blogs.es/df5c9b/3d-sonic-sensor-gen-2-1280x720/1366_2000.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
