...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia">La cultura de la ciberseguridad, una gran carencia en las empresas españolas según un informe de PwC España</h1>
                </div>
                <div class="col-12">
                    <img src="https://i.blogs.es/921cbc/office-1209640_1920/1366_2000.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <p>El 86 % de las compañías españolas carecen de una cultura de ciberseguridad entre los empleados, ese es el demoledor y principal dato que arroja el último informe del estado de cultura de ciberseguridad en el entorno empresarial elaborado por la firma de consultoría PwC España.

                            El área de Cyber Risk Culture de esta compañía ha presentado este martes los resultados de este estudio realizado en una cincuentena de organizaciones del ámbito nacional a través de entrevistas a expertos, así como encuestas a responsables de ciberseguridad e investigación.</p>
                        <!-- BREAK 3 -->
                        <h2>La ciberseguridad en el entorno empresarial, un problema presente y futuro</h2>

                        <p>La seguridad informática en el entorno empresarial es un asunto capital. Un problema de primer orden si se quieren evitar ataques. Desde datos bancarios a información confidencial, pasando por sistemas internos o simples datos personales pueden ser los objetivos de los cibercriminales tanto en empresas grandes como en pequeñas. Los ataques, decía el CNI hace un año, provienen sobre todo de Rusia, Irán, China y Corea del Norte.

                            Por si fuese poco, la pandemia ha acelerado la transformación digital en muchas empresas, ha potenciado la adopción del teletrabajo y ha incrementado todavía más los ataques. Por eso, quizás más que nunca, la ciberseguridad importa. También en el ámbito empresarial.</p>
