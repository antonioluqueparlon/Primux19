...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Remiro mejor portero de la liga para los usuarios de TechnoTeam</h1>
                </div>
                <div class="col-12">
                    <img src="../../img/imgDeportes/futbol.jpg" alt="imgNoticia"
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <p>
                            A lo largo del mes de diciembre se llevó a cabo en la web de TechnoTeam una encuesta para elegir al mejor portero de LaLiga Santander.<br>
                            Tras una primera fase en la que estaban incluidos todos los porteros que jugaron al menos 90' durante la liga 2019/20 se clasificaron para la fase final junto a Álex Remiro
                            porteros como Oblak, Ter Stegen, Courtois, Vaclick ó Pacheco.<br><br>
                            <img src="../../img/imgDeportes/portero.jpg" alt="portero"
                            class=" img-fluid"><br><br>
                            Quedando la clasificación final de la siguiente manera:
