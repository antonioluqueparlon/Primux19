...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Queja en el fútbol madrileño</h1>
                </div>
                <div class="col-12">
                    <img src="../../img/imgDeportes/futbolAmateur.jpg" alt="imgNoticia"
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <>
                        Los clubs de Madrid se ponen en pie de guerra ante la imposición por parte de la Federación Madrileña de fútbol 
                        de jugar este fin de semana a pesar de seguir sufriendo los problemas derivados de la borrasca Filomena 
                        <br>  
                        No sólo se encuentran muchas instalaciones llenas de nieve si no que a día de hoy hay jugadores que llevan sin entrenar más de un mes 
                        y que deberían volver a jugar de inmediato sin realizar ningún entrenamiento y con campos, pocos en los que se pueda jugar, que son auténticas
                        pistas de hielo.
                        <br><br>
