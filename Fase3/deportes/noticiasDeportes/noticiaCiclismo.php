...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Inscripciones Vuelta Ciclista Andalucía</h1>
                </div>
                <div class="col-12">
                    <img src="../../img/imgDeportes/ciclismo3.jpg" alt="imgNoticia"
                ...
                <div class="col-sm-6">
                    <a href="noticiaCiclismoAnne.php" class="linkNoticia">
                        <div class="card divOtrasNoticias">
                            <div class="row no-gutters">
                                <div class="col-md-4 col-sm-12">
                                    <img src="../../img/imgDeportes/anne.jpg" class="img-fluid card-img" alt="">
                                </div>
                                <div class="col-md-8 col-sm-12">
                                    <div class="card-block px-2">
                                        <h4 class="card-title titNoticia">Fichaje Anne Santesteban</h4>
                                        <p class="card-text">La ciclista española cambia de equipo</p>
                                    </div>
                                </div>
                            </div>
                        </div>
