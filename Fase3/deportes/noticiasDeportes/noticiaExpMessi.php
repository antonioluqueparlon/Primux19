...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Las nuevas imágenes sobre la expulsión de Messi</h1>
                </div>
                <div class="col-12">
                    <img src="../../img/imgDeportes/expMessi.jpg" alt="imgNoticia"
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <p>
                            Tras el revuelo ocasionado por la expulsión de Leo Messi, jugador del FC Barcelona, tras agredir a Asier Villalibre con un manotazo tras una porfia salen nuevas imagenes que no se vieron ni mostraron al árbitro desde la sala VAR.
                            <br><br>
                            Más concretamente unas imágenes en las que parece ser que no golpea en la cabeza
                            ...
                            <video id="video" width="1040" height="365">
                                ...
                                <source src="../video/expulsion.ogv" type="video/ogv">
                                <source src="../video/expulsion.mp4" type="video/mp4">
                                <p>
                                    Your browser doesn't support HTML5 video.
                                    <a href="../video/expulsion.mp4">Download</a> the video instead.
                                </p>
                            </video>
                            <!-- Video Controls -->
