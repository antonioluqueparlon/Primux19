...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Dwight Howard explica su surrealista 'no renovación' con los Lakers y su fichaje por los Sixers minutos después</h1>
                </div>
                <div class="col-12">
                    <img src="../../img/imgDeportes/zapas.jpg" alt="imgNoticia"
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <p>
                        El veterano pívot Dwight Howard reconoció este jueves en su primera rueda de prensa desde que se hizo jugador de los Sixers de Filadelfia que la etapa con Los Angeles Lakers se trataba del pasado y ahora su objetivo era triunfar con el nuevo equipo.Aunque había puesto un tuit que tenía previsto regresar con los Lakers, a los que el pasado octubre ayudó a ganar el título de liga, Howard reconoció que no había sido "afortunado" ya que a las pocas horas aceptó la oferta de los Sixers.<br><br>
                        <img src="../../img/imgDeportes/howard3.jpg" alt="imgNoticia"
                        class="img-fluid" >
                        <br><br>
                        "Son cosas que pasan en este negocio, pero ahora todo está superado, los Lakers hicieron lo que pensaron que era mejor para ellos y yo busqué la opción más válida para mi", comentó Howard, de 34 años. "Estoy agradecido por lo conseguido en Los Ángeles y ahora es otra historia diferente, que me llena de emoción".<br>
                        <br>Howard se incorporó a los Lakers con un <strong>contrato mínimo no garantizado el verano pasado</strong>, después de que pareciera que su carrera podría terminar tras una temporada plagada de lesiones con los Wizards de Washington, con quienes apenas jugó nueve partidos.Pero Howard revivió su carrera con una gran temporada jugando principalmente como reserva de los Lakers, y fue clave en la obtención del campeonato como sustituto del titular Anthony Davis.<br><br>
                        Ahora, en su nueva etapa tendrá que adaptarse a un clima y ciudad diferente, pero sobre todo a jugadores con los que nunca antes ha competido.Aún así, dijo que no le preocupa el cambio rápido y que se siente bien acerca de como se encuentra físicamente de cara a la nueva temporada.<br><br>
                        </p>
                    </div>
                </div>
                                ...
                                <div class="col-md-3" style="float:left">
                                    <div class="card mb-2">
                                        <img class="card-img-top imgUltimasNoticias"
                                            ...
                                            alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Equipo femenino UCO</h4>
                                            <p class="card-text">La UCO crea un equipo de baloncesto femenino</p>
                                            <a href="noticiaBaloncesto.php" class="btn btn-primary linkNoticia">Ver más</a>
                                        </div>
                                    </div>
                                </div>
