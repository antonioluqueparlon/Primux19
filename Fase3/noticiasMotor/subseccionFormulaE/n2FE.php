...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Coronavirus: eventos cancelados en F1, MotoGP y más para 2021</h1>
                </div>
                <div class="col-12">
                    <img src="../img/covid.jpg" alt="imgNoticia"
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <h5><strong>La pandemia de COVID-19 (coronavirus) ya ha obligado a modificar los calendarios 2021 de F1, MotoGP y más categorías tras cambiar completamente la temporada 2020.</strong></h5>
                        <p>La pandemia de coronavirus y la crisis sanitaria por COVID-19 tienen al mundo en alerta. Muchos países han tomado medidas de protección para prevenir la propagación del virus, y las carreras de motociclismo y automovilismo no son ajenas.</p>
                        </br><p>El motorsport también se ve afectado: al igual que en 2020, muchos eventos de carreras también se cancelarán o pospondrán en 2021. Este resumen proporciona información sobre noticias actuales y cancelaciones de citas como las siguientes:
                        </p>
                        </br>
                        <ul>
                        <li><h5><strong>DTM: San Petersburgo cancelado</strong></h5>
                        <p>Se canceló el inicio de la temporada 2021 del DTM previsto del 28 al 30 de mayo en la pista de carreras Igora Drive cerca de San Petersburgo (Rusia). Ahora, la primera temporada de la historia del DTM con coches GT3 comenzará del 18 al 20 de junio en Monza (Italia).</p></li>
                        <li><h5><strong>Rallies: Rally histórico de Montecarlo cancelado</strong></h5>
                        <p>En el WRC (Campeonato del Mundo de Rallies), el Rally de Montecarlo tendrá lugar del 21 al 24 de enero. La versión histórica del rally, que estaba programada del 30 de enero al 3 de febrero, ha sido cancelada. El Automobile Club de Monaco lo confirmó. El Rally de Montecarlo debería disputarse según lo previsto.</p>
                        <li><h5><strong>MotoGP: nuevo test de invierno en Qatar, cancelado Malasia</strong></h5>
                        <p>Dado el estado de alarma instaurado en Malasia, las pruebas de MotoGP previstas para febrero en el Circuito Internacional de Sepang tuvieron que cancelarse. El test oficial (19-21 de febrero) y el shakedown (14-16 de febrero) son los afectados.</p>
                        </ul>
