...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Un fabricante de carcasas de PS5 se declara "intocable" por Sony tras encontrar una brecha legal</h1>
                </div>
                <div class="col-12">
                    <img src="img/carcasanegra.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                    <div class="card-img-overlay d-flex align-items-end">
                        <p class="card-text font-weight-bold txtTop">Será posible comprar el ansiado recambio negro de la consola mientras se aprueba la patente.</p>
                    </div>
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        ...
                        Desde antes incluso de que PlayStation 5 se pusiera oficialmente a la venta, muchos fabricantes se han marcado como objetivo
                        hacer las <strong>carcasas intercambiables</strong> una realidad: hablamos de tapas de plástico muy fáciles de colocar, por lo que personalizar
                        la consola estaría al alcance de cualquiera… de no ser porque <strong>Sony</strong> ha decidido proteger
                        sus derechos como propietario intelectual de la marca, retirando del mercado todos estos productos. Hasta hoy.
                        <br><br>

                        La compañía anteriormente conocida como PlateStation 5 y luego, como Customize My Plates, vuelve ahora a la carga como <strong>CMP Shells</strong>
                        y tiene lo que considera una <strong>estrategia ganadora</strong> consigo: patentar
                        su producto y venderlo mientras se estudia la aprobación de esa misma patente. A la tercera va la vencida, se suele decir.
                        <br><br>

                        "La <strong>patente</strong> está pendiente, y todas las ventas que se finalizan antes de que esté aprobada son intocables.
                        Es algo que antes no sabíamos. Ahora lo sabemos" reza su página web.
                        "Además, no hemos imitado el diseño bajo la propiedad de nadie.
                        Nuestras carcasas mejoran las originales permitiendo una <strong>ventilación superior.</strong>
                        Seremos capaces de venderlas incluso después de que se apruebe la patente".

                        <br><br>

                        En la corta historia de PlayStation 5 hay un buen número de terceros que han caído tratando de hacer exactamente lo mismo.
                        Las más aguerridas, como dbrand, <strong>desafían abiertamente a Sony</strong> confiando en sus derechos legales como vendedor.
                        SUP3R5, por otro lado, <strong>canceló las reservas de sus PlayStation 5 inspiradas en PS2,</strong> solo que en este caso fue por
