...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">Todos los detalles de GeForce RTX 3060 Ti, la tarjeta gráfica de Nvidia RTX 30 más barata</h1>
                </div>
                <div class="col-12">
                    <img src="img/rtx3060.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                    <div class="card-img-overlay d-flex align-items-end">
                        <p class="card-text font-weight-bold txtTop">Nvidia presenta su nueva gama de tarjetas gráficas, disponibles desde el 2 de noviembre.</p>
                    </div>
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        ...
                        Tal y como estaba previsto,<strong>Nvidia</strong> ha presentado su nueva gama de tarjetas gráficas de la familia RTX 3060.
                        Lo ha hecho con la <strong>GeForce RTX 3060 Ti</strong>, que destaca por ser la primera potenciada por la arquitectura Ampere
                        y la segunda generación de RTX.
                        <br><br>

                        GeForce RTX 3060 Ti reúne todos los requisitos para ser una excelente opción como plataforma de videojuegos para PC.
                        Incorpora <strong>tecnología de trazado de rayos</strong> y de inteligencia artificial DLSS, y permite jugar a 1080p y a 1440p.
                        <br><br>
                        <h2><strong>Estará disponible a un precio de 419 euros</strong></h2>
                        <br>

                        Tal y como indican en el comunicado de prensa, incorpora la denominada <strong>trifecta de innovaciones GeForce</strong>
                        , incluyendo la tecnología de mejora de rendimiento por IA, NVIDIA DLSS, NVIDIA Reflex y NVIDIA Broadcast.
                        DLSS está disponible en más de 25 juegos, y cada mes se suman nuevos títulos; La tecnología NVIDIA Reflex reduce la
                        latencia del sistema haciendo que los juegos respondan mejor,
                        especialmente en propuestas multijugador y Broadcast añade un conjunto de mejoras de audio y video
                        <br><br>

                        “Estamos entrando en una temporada de navidades impresionante, con efectos generados por trazado de rayos en videojuegos
                        como <strong>Cyberpunk 2077, Call of Duty: Black Ops Cold War,
                        Watch Dogs: Legion y más títulos,” </strong> ha dicho Matt Wuebbling, VP de Global GeForce Marketing en NVIDIA.
                        <br><br>

                        GeForce RTX 3060 Ti estará disponible desde el <strong>2 de diciembre a un precio de 419 euros.</strong>
                        Aunque como ocurre con las gamas 3080 y 3090, será complicado hacerse con una de estas tarjetas gráficas
                        debido al escaso stock. Nvidia también cuenta con GeForce Now, un sistema de juego en nube al
