...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia ">El nuevo equipo de Sony en San Diego trabaja en marcas existentes de PlayStation para PS5</h1>
                </div>
                <div class="col-12 imgNoticia">
                    <img src="img/fondoplaystation.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                    <div class="card-img-overlay d-flex align-items-end">
                        <p class="card-text font-weight-bold txtTop">De acuerdo a un ex empleado, el estudio desarrolla un videojuego de acción y aventura triple-A.</p>
                    </div>
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        ...
                        Continúa llegando a cuentagotas información sobre el estudio aún por presentar de <strong>Sony</strong> en San Diego, todo un misterio de la industria si no fuera por pequeños datos compartidos en redes.
                        Lo último que hemos podido conocer a través de LinkedIn es que este nuevo equipo de desarrollo
                        tiene como misión <strong>expandir franquicias ya existentes</strong> y dar forma a nuevas historias para una próxima generación de jugadores,
                        lo que se traduce una producción con vistas a estrenarse en PlayStation 5.
                        <br><br>

                        Esta afirmación llega a través del perfil en esta plataforma de Michael Mumbauer, un veterano de Sony en San Diego
                        que dejó la compañía en noviembre del pasado año. En ella se expone que el último hito de Mumbauer fue la puesta
                        en marcha de un nuevo estudio para PlayStation en la mencionada ciudad con el objetivo de crear un<strong>videojuego
                        de acción y aventura con gran presupuesto (o triple-A)</strong> utilizando tecnología propia. Las metas de esta nueva empresa,
                        continúa el mensaje, no serían otras que las de trabajar en marcas ya presentadas al mercado.
                        Sobre cuáles podrían ser estas IP no se han compartido pistas concretas.
                        <br><br>

                        Hace unos meses este equipo de desarrollo fue noticia por un posible cierre, algo desmentido
                        por ex miembros del estudio al poco tiempo. Estas especulaciones saltaron tras el anuncio de la marcha de varios
                        de sus primeros empleados,
                        sin embargo uno de ellos, John Bautista, aseguró que su despedida respondía a motivos personales.
                        <br><br>

                        <h1>Nuevo grupo de desarrollo de PlayStation Studios</h1><br><br>
                        Este nuevo equipo interno de PlayStation Studios <strong>echó a andar en 2018.</strong> En concreto,
                        la primera noticia que tuvimos de su existencia data de abril de dicho año, por lo que,
                        si no ha habido excesivas complicaciones en su formación, no sería de extrañar que pronto se
                        compartiera información más palpable sobre la empresa. Desde redes sociales ya hay quien especula con que
                        esta empresa podría tomar las riendas de la <strong>serie Uncharted</strong>, si bien, repetimos, no han trascendido
                        pistas firmes que lo puedan corroborar.
                        <br><br>


                        <strong>PlayStation Studios tiene varios equipos de desarrollo</strong> repartidos por todo el mundo,
