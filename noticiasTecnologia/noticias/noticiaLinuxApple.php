...
<body>
    ...
    <main>
        <section class="noticia">
            <div class="row ">
                <div class="col-12">
                    <h1 class="titNoticia">Logran arrancar y usar Ubuntu Linux (con interfaz gráfica) en el M1 de Apple: Corellium es la primera en conseguirlo</h1>
                </div>
                <div class="col-12">
                    <img src="https://i.blogs.es/a8d6f6/linux-ubuntu/1366_2000.jpg" alt="imgNoticia" class="imgNoticia img-fluid">
                ...
                <div class="row cuerpoNoticia">
                    <div class="col-12">
                        <p>Hace unos días hablábamos de cómo Corellium, una compañía de virtualización, había logrado arrancar Linux en el M1. Sin embargo, aquello fue una beta temprana del sistema en el nuevo chip de Apple, sin interfaz gráfica de usuario y muy limitada.
                        ...
                        <!-- BREAK 3 -->
                        <h2>Arranque desde USB y red vía USB: Corellium publicará un tutorial para que quien quiera pueda instalarlo</h2>
