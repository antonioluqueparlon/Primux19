...
<section class="content">
		<div class="row introNoticia">
			<div class="row ">
				<h1 >NOMBRE NOTICIA</h1>
			</div>
			<div class="row">
				<img src="http://lorempixel.com/output/sports-q-c-1150-900-3.jpg" alt="imgNoticia" >
			...
			<div class="row cuerpoNoticia">
				...
				Odio fringilla sociis gravida viverra suspendisse est luctus phasellus, nulla ornare enim mattis ultrices primis eu sem, vitae hac himenaeos massa ultricies metus euismod.<br>
				...
				Accumsan mauris integer varius sapien aenean imperdiet curabitur cubilia quis leo posuere lacus rutrum, primis suscipit nulla ante hac pellentesque sociosqu egestas pretium velit porttitor. Malesuada sociis fringilla dictum purus massa nibh, sagittis quam donec habitasse feugiat fames, congue eleifend et faucibus scelerisque.<br>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row divOtrasNoticias">
						...
						<p  class="txtOtrasNoticias">Lorem ipsum dolor sit amet consectetur.</p>				
					</div>
				</div>
				<div class="col-md-6">
					<div class="row divOtrasNoticias">
