...
<body>
    ...
    $noticia1 = NoticiaController::recuperarNoticiaApartadoVideojuegosMasReciente();
            ...
            <section class="content">
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-12 d-sm-none d-none d-md-block">
                        ...
                        <?php
                        //PARA PÁGINA PRINCIPAL RECUPERAMOS 4 NOTICIAS DE MANERA ALEATORIA
                        $noticia1 = NoticiaController::recuperarNoticiaApartadoVideojuegosDerecha();
                        foreach ($noticia1 as $value) {
                        ?>
                            <div class="row">
                                <div class="col-md-12">
    ...
    -->
          ...
          <li data-target="#demo" data-slide-to="2"></li>
                            ...
                            <div class="carousel-inner">
                                <?php
                                //PARA PÁGINA PRINCIPAL RECUPERAMOS 4 NOTICIAS DE MANERA ALEATORIA
                                $noticia1 = NoticiaController::recuperarNoticiaApartadoVideojuegosDerechaUnasolo();
                                foreach ($noticia1 as $value) {
                                ?>
                                    <div class="carousel-item active">
                                        <a href="noticia.php?id=<?php echo $value->id; ?>">
                                            <img class="img-fluid" src="<?php echo $value->imagen; ?>" alt="" width="70%" height="200">
                    ...
                    <?php
                    $noticiasUltimas = NoticiaController::recuperarNoticiasUltimasNoticiasVideojuegos();
